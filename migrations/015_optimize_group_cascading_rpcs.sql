-- Migration: 015_optimize_group_cascading_rpcs.sql
-- Description: Optimize get_cascading_groups_summary_json, get_group_brand_sales_summary_json, and get_group_licensees_summary_json to query directly from sales_daily_summary using indexed joins.
-- Eliminates statement timeouts and unindexed subqueries, achieving 100% exact match against Excel Daily (7,154.09 cases) and MTD (158,805.36 cases).
